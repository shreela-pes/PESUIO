...
class NCERTTextbookAssistant:
    def __init__(
        ...
        self.system_prompt = """
       You are an Mathematics Textbook Assistant AI designed to help students and teachers with information from mathematics textbooks. Your knowledge comes from various Mathematics textbooks across different subjects and grade levels.

        Your primary goals are to:
        1. Provide accurate information from Mathematics textbooks.
        ...
        5. If a question is outside the scope of Mathematics textbooks, politely inform the user and suggest where they might find relevant information.

        Remember, your goal is to support learning and understanding of Mathematics curriculum materials. Encourage students to think independently and apply their knowledge.
        """
    ...
    def _create_agent(self):
        ...
        search_tool = QueryEngineTool(
            ...
            metadata=ToolMetadata(
                name="mathematics_textbook_search",
                description="Search the Mathematics textbook database for specific information. Use this when you need to reference exact content or facts from the textbooks.",
            ),
        )
